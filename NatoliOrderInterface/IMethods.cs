                                ...
                                try
                                {
                                    ...
                                    if (!string.IsNullOrWhiteSpace(quoteLineItem.HobNoShapeID) && _nat01Context.HobList.Any(h => h.HobNo == quoteLineItem.HobNoShapeID && h.TipQty == (quoteLineItem.TipQTY ?? 1) && h.BoreCircle == (quoteLineItem.BoreCircle ?? 0)))
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            var match = Regex.Match(quote.EngineeringNote1 + " " + quote.EngineeringNote2 + " " + quote.MiscNote, regex);
                                            if (match.Success)
                                            {
                                            ...
                                            else
                                            {
                                                ...
                                                match = Regex.Match(quote.EngineeringNote1 + " " + quote.EngineeringNote2 + " " + quote.MiscNote, regex);
                                                if (match.Success)
                                                {
                                                    string refDieID = match.Value;
