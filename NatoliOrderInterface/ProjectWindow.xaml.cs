...
namespace NatoliOrderInterface
{
    ...
    public partial class ProjectWindow : Window, IDisposable, IMethods
    {
        ...
        private bool FormCheck()
        {
            ...
            if ((CreateButton.Content == "Create" || user.Department != "Engineering") && (Priority.IsChecked == false && ((DueDate.Text.StartsWith('0') || (DueDate.Text.StartsWith('1') && DateTime.Now.TimeOfDay > new TimeSpan(14, 0, 0))) || (DueDate.Text.StartsWith('2') && DateTime.Now.DayOfWeek == DayOfWeek.Saturday))))
            {
